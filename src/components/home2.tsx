...
export default function home2() {
  return (
    <>
        <div className='flex flex-wrap justify-center items-center w-full h-max bg-white text-gray-700 z-10'>
          <div className="flex-col w-1/2 px-15 py-15">
            <img src={Image} className='flex-1/2 p-10'/>
            <h1 className='flex text-4xl px-10 pt-0 text-teal-800'>Notre Mission</h1>
          ...
          <div className="flex-col w-1/2 px-15 py-15">
          <h1 className='text-4xl pt-15 px-10 text-teal-800'>
              Notre Objectif
          </h1>
