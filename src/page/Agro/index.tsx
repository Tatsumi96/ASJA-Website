...
const descriptionParcours = [
  ...
  },
  {
    ...
    debouche:
      'Débouchés professionnels : Techniciens/Ingénieur agroalimentaire Responsable de production Chargé de développement de produits Technicien Ingénieur en contrôle qualité Analyste en laboratoire alimentaire Responsable assurance qualité Consultant Cadres et Techniciens au sein du Ministère de l’Industrialisation et du Commerce, des ONG, des sociétés et des bureaux d’études',
