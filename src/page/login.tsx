    ...
    <div className="flex justify-center items-center w-full h-screen bg-white">
      ...
      <div className="flex w-1/2 h-screen justify-center items-center">
        <div className="flex-col w-100 justify-center items-center p-10">
            ...
            <label >Email</label>
            <input className="flex w-full mb-5 border-gray-300 border-2 focus:ring-0 focus:outline-none rounded-md p-2 " type="email" />
            <label >Mot de passe</label>
            <input className="flex w-full mb-5 border-gray-300 border-2 focus:ring-0 focus:outline-none rounded-md p-2" type="password" />
            <button className="flex w-full justify-center focus:bg-teal-600 hover:bg-teal-600 shadow-lg shadow-gray-400 hover:scale-101 duration-300 rounded-full cursor-pointer bg-teal-800 text-white p-3">
                se connecter
            </button>
