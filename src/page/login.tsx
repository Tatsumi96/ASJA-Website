    ...
    <div className="flex justify-center items-center w-full h-screen bg-white">
        <a onClick={() => window.location.href = '/'}>
          <div className='flex m-2 rounded-full top-3 left-10 fixed'>
            <img className='w-13 h-13 ' src={Logo} />
            <h1 className='py-3 pr-4 ml-3 font-bold text-gray-800'>ASJA University</h1>
          </div>
        </a>
      ...
      <div className="flex w-1/2 h-screen justify-center items-center">
        <div className="flex-col w-100 justify-center items-center p-10">
            <h1 className="flex justify-center mb-5 text-2xl font-bold text-gray-800">Connexion</h1>
            <label >Email</label>
            <input className="flex w-full mb-5 border-gray-300 border-2 focus:ring-0 focus:outline-none rounded-md p-2.5 " type="email" />
            <label >Mot de passe</label>
            <input className="flex w-full mb-5 border-gray-300 border-2 focus:ring-0 focus:outline-none rounded-md p-2.5" type="password" />
            <button className="flex w-full justify-center focus:bg-gray-600 hover:bg-gray-600 shadow-lg shadow-gray-400 hover:scale-101 duration-300 rounded-full cursor-pointer bg-gray-900 text-yellow-500 p-3.5">
                se connecter
            </button>
