...
export const Description = () => {
  return (
    <section className="flex h-screen w-screen flex-row z-0 bg-white">
      <div className="flex flex-col justify-center px-20 p-10 w-1/2">
        ...
        <button 
          className="flex items-center justify-center w-max bg-green-800 hover:bg-green-900 cursor-pointer hover:scale-105 duration-300 py-4 rounded-full mt-10">
          <a 
            href="/about" 
            className="text-white font-bold text-lg mx-5"
            >
              En savoir plus →
            </a>
