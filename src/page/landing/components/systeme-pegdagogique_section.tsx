export const SystemePedagogiqueSection = () => {
      ...
      <div className="w-full bg-white dark:bg-zinc-800 dark:text-white py-16 px-10">
        ...
        <div className="flex items-center justify-center relative max-w-7xl mx-auto h-[600px] ">
          <div className="absolute top-16 left-40 w-80 z-10">
            <h2 className="text-3xl font-bold text-gray-700 dark:text-white mb-4 text-right">LMD</h2>
          ...
          <div className="absolute top-16 right-40 w-80 z-10">
            <h2 className="text-3xl font-bold text-gray-700 dark:text-white mb-4 ">LOREM</h2>
          ...
          <div className="absolute bottom-16 left-40 w-80 z-10">
            <h2 className="text-3xl font-bold text-gray-700 dark:text-white mb-4 text-right">LOREM</h2>
            <p className="text-gray-600 dark:text-gray-300  text-right text-sm leading-relaxed">
  ...
  Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi animi velit aliquid neque cumque cupiditate quas fuga ducimus.
          ...
          <div className="flex items-center justify-center w-3/4 flex-wrap z-[1]">
            <div className="h-80 w-80 rounded-tl-full bg-gradient-to-tl from-gray-100 via-gray-200 to-gray-300 dark:from-zinc-800 dark:via-zinc-700 dark:to-zinc-600 m-5"></div>
            <div className="h-80 w-80 rounded-tr-full bg-gradient-to-tr from-gray-100 via-gray-200 to-gray-300 dark:from-zinc-800 dark:via-zinc-700 dark:to-zinc-600 m-5" ></div>
            <div className="h-80 w-80 rounded-bl-full bg-gradient-to-bl from-gray-100 via-gray-200 to-gray-300 dark:from-zinc-800 dark:via-zinc-700 dark:to-zinc-600 m-5"></div>
            <div className="h-80 w-80 rounded-br-full bg-gradient-to-br from-gray-100 via-gray-200 to-gray-300 dark:from-zinc-800 dark:via-zinc-700 dark:to-zinc-600 m-5"></div>
          </div>
