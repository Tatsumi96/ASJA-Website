...
export const DispositionAboutFiliere = ({
  ...
  return (
    <div className="flex flex-col overflow-x-hidden dark:bg-zinc-900 bg-white">
      ...
      >
        <div className="flex-1  mb-10 max-w-2xl p-8 text-left transition-all duration-500">
        ...
        <div className="flex-1 max-w-md p-6 text-left relative overflow-hidden transition-all duration-700 mb-10">
          <img
